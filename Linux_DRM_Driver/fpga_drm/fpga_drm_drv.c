...
#define FPGA_HW_DDR_AXI_BASE		0x40000000ULL
#define FPGA_HW_DDR_AXI_SIZE		0x40000000ULL
#define FPGA_HW_DDR_AXI_END		(FPGA_HW_DDR_AXI_BASE + \
					 FPGA_HW_DDR_AXI_SIZE - 1)
#define FPGA_HW_BYPASS_AXI_TRANSLATION	0x3F000000ULL
#define FPGA_HW_BYPASS_RESOURCE_SIZE	0x02000000ULL
#define FPGA_HW_BYPASS_HOST_USABLE_SIZE	0x01000000ULL
#define FPGA_HW_DDR_BYPASS_AXI_BASE	0x3F800000ULL
#define FPGA_HW_DDR_BYPASS_SIZE		0x00800000ULL
...
/* Per-master addresses for MIG memaddr offset zero; they need not match. */
#define FPGA_HW_GOP_BYPASS_FRAME_BASE	0x3F800000ULL
#define FPGA_HW_GOP_BYPASS_FRAME_END	(FPGA_HW_GOP_BYPASS_FRAME_BASE + \
					 FPGA_DRM_MAX_FRAME_BYTES - 1)
#define FPGA_HW_GOP_VDMA_FRAME_BASE	0x40000000ULL
#define FPGA_HW_GOP_VDMA_FRAME_END	(FPGA_HW_GOP_VDMA_FRAME_BASE + \
					 FPGA_DRM_MAX_FRAME_BYTES - 1)
#define FPGA_HW_FRAME_BASE		0x41000000ULL
#define FPGA_HW_FRAME_RING_END		(FPGA_HW_FRAME_BASE + \
					 (FPGA_HW_FRAME_COUNT - 1) * \
					 FPGA_HW_FRAME_SPACING + \
					 FPGA_DRM_MAX_FRAME_BYTES - 1)

#define FPGA_HW_PIXEL_UNPACK_BASE	0x3F000000ULL
#define FPGA_HW_VTC_BASE		0x3F010000ULL
#define FPGA_HW_AXI_IIC_BASE		0x3F020000ULL
#define FPGA_HW_VDMA_BASE		0x3F040000ULL
#define FPGA_HW_COLOR_CONVERT_BASE	0x3F050000ULL
#define FPGA_HW_VIDEO_CLK_WIZ_BASE	0x3F060000ULL
#define FPGA_HW_VIDEO_LOCK_GPIO_BASE	0x3F070000ULL
