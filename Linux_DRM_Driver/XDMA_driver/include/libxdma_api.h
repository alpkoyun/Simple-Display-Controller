...
ssize_t xdma_xfer_submit_lines_nowait(void *cb_hndl, void *dev_hndl, int channel, bool write, u64 ep_addr,
			struct sg_table *sgt, bool dma_mapped, unsigned int line_size,
